...
>
	...
	<div class="whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Tìm kiếm trên web</div>
	<div class="group relative w-max">
		...
		>
			<p class="max-w-sm text-sm text-gray-800 dark:text-gray-200">
				Khi được bật, mô hình sẽ cố gắng bổ sung câu trả lời của mình với thông tin truy vấn từ web.
			</p>
		</div>
	</div>
</div>
